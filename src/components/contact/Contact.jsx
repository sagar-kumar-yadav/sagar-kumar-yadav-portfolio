...
const Contact = () => {
  ...
  return (
    <section id="contact" className="contact_con bg-white w-full">
      <div className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 font-semibold text-black w-[75%]">
